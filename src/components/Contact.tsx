...
const Contact = () => {
  return (
    <section id="contact" className="py-16 md:py-24 bg-beseng-navy text-white">
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
          <div>
            <h3 className="text-2xl font-bold mb-6 text-beseng-orange">Get In Touch</h3>
            <div className="space-y-6">
              <div className="flex items-start">
                <div className="mr-4 text-beseng-orange">
                  <MapPin size={24} />
                </div>
                <div>
            ...
            <div className="mt-8">
              <h3 className="text-2xl font-bold mb-4 text-beseng-orange">Follow Us</h3>
