    ...
    <nav
      className={`fixed w-full z-50 transition-all duration-300 ${
        isScrolled
          ...
          : "bg-white/10 backdrop-blur-2xl shadow-md py-2"
      }`}
    >
      <div className="container mx-auto px-4">
        <div className="flex justify-between items-center">
          ...
          <button
            className={`md:hidden ${
              isScrolled ? "text-beseng-navy" : "text-white"
            }`}
        ...
        {isMenuOpen && (
          <div
            className={`md:hidden absolute top-full left-0 w-full shadow-lg animate-fade-in ${
              isScrolled
